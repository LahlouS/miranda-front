import { w as push, O as ensure_array_like, I as push_element, J as pop_element, P as bind_props, y as pop, F as FILENAME } from './index-D58S01WZ.js';
...
function _page($$payload, $$props) {
  ...
  for (let $$index_3 = 0, $$length = each_array.length; $$index_3 < $$length; $$index_3++) {
    ...
    $$payload.out += `<h2 class="text-xl font-semibold text-gray-900 flex items-center justify-between">`;
    push_element($$payload, "h2", 30, 10);
    $$payload.out += `<span>`;
    push_element($$payload, "span", 31, 12);
    $$payload.out += `(${escape_html(product.pid)}) ${escape_html(product.type)}</span>`;
    pop_element();
    $$payload.out += ` `;
    if (product.isRunning) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<span class="text-green-300">`;
      push_element($$payload, "span", 33, 14);
      $$payload.out += `[running]</span>`;
      pop_element();
    } else {
      $$payload.out += "<!--[!-->";
    }
    ...
    pop_element();
    $$payload.out += ` <div class="mt-4">`;
    push_element($$payload, "div", 49, 10);
    $$payload.out += `<h3 class="font-medium text-gray-700">`;
    push_element($$payload, "h3", 50, 12);
    $$payload.out += `Life is a bless with your product:</h3>`;
    pop_element();
    $$payload.out += ` <ul class="list-disc pl-5 space-y-2 text-gray-600">`;
    push_element($$payload, "ul", 51, 12);
    $$payload.out += `<!--[-->`;
    for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
      let tp = each_array_2[$$index_1];
      $$payload.out += `<li>`;
      push_element($$payload, "li", 53, 16);
...
//# sourceMappingURL=_page.svelte-U6bC3Hjq.js.map
