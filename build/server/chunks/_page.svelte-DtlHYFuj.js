import { w as push, P as store_get, N as ensure_array_like, I as push_element, J as pop_element, Q as unsubscribe_stores, O as bind_props, y as pop, F as FILENAME, K as getContext } from './index-DxcH4qTA.js';
...
function _page($$payload, $$props) {
  ...
  push_element($$payload, "div", 172, 1);
  {
    ...
    push_element($$payload, "div", 175, 2);
    $$payload.out += `<div class="animate-spin rounded-full h-10 w-10 border-b-2 border-gray-500">`;
    push_element($$payload, "div", 176, 4);
    $$payload.out += `</div>`;
    pop_element();
    $$payload.out += ` <p class="ml-3 text-gray-700 font-semibold">`;
    push_element($$payload, "p", 177, 4);
    $$payload.out += `Loading users...</p>`;
    pop_element();
    $$payload.out += `</div>`;
    pop_element();
  }
...
//# sourceMappingURL=_page.svelte-DtlHYFuj.js.map
