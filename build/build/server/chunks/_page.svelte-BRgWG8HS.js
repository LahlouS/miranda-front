import { w as push, I as push_element, J as pop_element, P as bind_props, y as pop, F as FILENAME } from './index-D58S01WZ.js';
...
function _page($$payload, $$props) {
  ...
  push_element($$payload, "div", 22, 4);
  $$payload.out += `<div class="text-center mb-12 svelte-g3jc82">`;
  push_element($$payload, "div", 23, 6);
  ...
  push_element($$payload, "form", 43, 6);
  if (form?.error) {
    $$payload.out += "<!--[-->";
  ...
  if (form?.success) {
    ...
    push_element($$payload, "div", 55, 10);
    $$payload.out += `<p class="text-green-700 svelte-g3jc82">`;
    push_element($$payload, "p", 56, 12);
  ...
  push_element($$payload, "textarea", 80, 10);
  ...
  push_element($$payload, "button", 91, 8);
...
//# sourceMappingURL=_page.svelte-BRgWG8HS.js.map
